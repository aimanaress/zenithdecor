...
function Footer() {
  return (
    <footer className="w-full bg-background p-8">
        ...
        <ul className="flex flex-wrap items-center justify-center gap-y-2 gap-x-36 ">
          <li>
            <Typography
              as="a"
              href="#"
              className="font-normal transition-colors hover:text-highlight focus:text-blue-500"
            >
              About Us
            </Typography>
          </li>
      ...
      <div className="flex gap-4 text-gray-500 sm:justify-center py-8">
        <Typography
          as="a"
          href="#"
